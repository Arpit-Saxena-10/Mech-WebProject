...
from flaskblog.models import Course, Faculty, Student, User
...
if __name__ == '__main__':
    ...
    faculty_1 = Faculty(username='admin1', email='admin1@iitb.ac.in', password='admin1', role='admin')
    faculty_2 = Faculty(username='admin2', email='admin2@iitb.ac.in', password='admin2', role='admin')
    ...
    db.session.add(faculty_1)
    db.session.add(faculty_2)
